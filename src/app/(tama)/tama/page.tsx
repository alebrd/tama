      ...
      <div className="container">
        <div className={styles.grid}>
          <div className={styles.card}>
            ...
            <p className={styles.cardText}>
              Ponad 1 100 m² elastycznej przestrzeni, profesjonalne zaplecze techniczne, nagłośnienie i oświetlenie pozwalają na organizację zarówno kameralnych spotkań, jak i dużych wydarzeń dla kilkuset osób.
            </p>
            <p className={styles.cardText}>
          ...
          <div className={styles.card}>
            ...
            <Link href="/oferta" className={styles.venueLink}>
              POZNAJ MOŻLIWOŚCI →
            </Link>
          </div>
        </div>
